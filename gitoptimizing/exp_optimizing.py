...
#We use the name "speakers" as it corresponds to speakers for Voxceleb, but it corresponds to words utterated for Librispeech
...
epsilon  = 0.05  # Noise around the initialization if we chose sparsemax as a function 
#Function choice

function=torch.nn.Softmax
sparse = True # Put true if you want to use sparsemax instead of softmax, it also changes the initialization 
...
sigma = 0 # Norm 2 penality , it has finally not been used in the paper.
